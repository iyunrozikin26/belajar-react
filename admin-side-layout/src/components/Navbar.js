...
const NavigationBar = () => {
    return (
        <>
            <nav className="bg-dark-400 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <Link to="/movies">
                        <a href="#" className="flex items-center">
                            ...
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HackMovies</span>
                        </a>
                    </Link>
